method MAILSSET_UPDATE_ENTITY.
  ...
  DATA es_mail TYPE ZCL_ZSV_DATOS_MAESTROS_MPC=>TS_MAILS.
  ...
  io_data_provider->read_entry_data( IMPORTING es_data = es_mail ).
